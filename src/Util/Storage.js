...
var Storage = cc.Class.extend(
{
    ...
    invokeSDK2 : function() 
    {
        ...
        if ("undefined" != typeof(sdkbox.PluginShare)) {
            ...
            {
                plugin.share( {text : "Phoneアプリ『ヤギダン』を始めたメェー！! https://itunes.apple.com/app/id1058265886"} );
            }else{
                plugin.share( {text : "Phoneアプリ『ヤギダン』で" + this.totalGameScore + "匹集めたメェー！! https://itunes.apple.com/app/id1058265886"} );
            }
        } else {
            console.log("no plugin invoked")
        }
